<?php
/**
 * Endpoint web "fire-and-go" para ajustar tiempos de tareas RACK.
 *
 * Uso:
 *   1) Abre en el navegador:
 *      http://localhost/PLAN_ATTAINMENT/tools/ajustar_racks_now.php
...
// Requiere login (cualquier rol vale; este endpoint vive bajo tools)
Auth::requireLogin();
...
if ($apply) {
    try {
        ...
        // 1) UPDATE mant_plan con CTE: random 5-8 si N<=5, reparto uniforme si N>=6
        $sqlPlan = "
            WITH racks AS (
...
<?php if ($apply): ?>
    ...
    <p style="margin-top:18px">
        ...
        <a href="../views/mant_proximas.php" style="color:#2d4d7a">Ir a Próximas Revisiones</a>
    </p>
