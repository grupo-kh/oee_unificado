<?php
$pageTitle = 'Cumplimiento Global Producción';
...
<div class="pa-filterbar" id="pa-filterbar">
    <div class="pa-filterbar-row">
        ...
        <div class="pa-filterbar-group">
            <button type="button" id="pa-refresh-btn" class="pa-refresh-btn" title="Recargar datos (omite caché)">
...
<main class="view-main pa-stack">
    ...
    <div class="view-card pa-module pa-module-1">
        <div class="view-card-header">
            <h2 id="m1-title">Cumplimiento Global Producción<button type="button" id="info-icon" class="info-icon" title="Cómo se ha leído esta información" aria-label="Cómo se ha leído esta información">i</button></h2>
        </div>
